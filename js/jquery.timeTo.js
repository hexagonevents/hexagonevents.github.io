...
(function (factory) {
    ...
    var defaults = {
        ...
        displayDays: true,          // display day timer, count of days digits
        displayHours: true,      // display hours
        fontSize: 40,            // font-size of a digit by pixels
    ...
    $.fn.timeTo = function(){
        ...
        return this.each(function() {
            ...
            if(!data.vals || method === 'reset') { // new clock
                ...
                data.width = Math.round(data.fontSize * .5 + data.height * .13);
                ...
                var left = Math.round(data.height / 10),
                    ulhtml = '<ul style="width:25px; left:'+ left +'px; top:-'+ data.height +'px"><li>0</li><li>0</li></ul></div>',
